...
4. If $a= \begin{bmatrix} a \\ b \end{bmatrix}$ is an eigenvector of a matrix **A**, then the unit vector  $â= \begin{bmatrix} a & 0 \\ 0 & b \end{bmatrix}$ is a ==**normalised eigenvector**== of A.
